    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 pt-16">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto">
          Journey through the life of the final messenger with interactive timelines, 
          engaging stories, and meaningful lessons for all ages
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/learn" className="bg-emerald-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-emerald-700 transform hover:scale-105 transition-all shadow-lg inline-block text-center">
            Start Your Journey
          </Link>
          <button className="bg-white text-emerald-600 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-gray-50 transform hover:scale-105 transition-all shadow-lg border-2 border-emerald-600">
            Watch Introduction
          </button>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
            ...
            <p className="text-gray-600">Follow the chronological journey from birth to the final sermon</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
            ...
            <p className="text-gray-600">Read beautifully narrated stories from authentic sources</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
            ...
            <p className="text-gray-600">Extract wisdom and guidance for modern life challenges</p>
          </div>
        </div>
      </div>
    </section>
