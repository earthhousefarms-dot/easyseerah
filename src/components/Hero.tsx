    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 pt-16">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6">
          Learn Seerah the Easy Way
          <span className="block text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600 mt-2">
            Prophet Muhammad's ﷺ Life Story
          </span>
        </h1>
        
        <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto">
          Learn about Prophet Muhammad ﷺ with <strong>simple lessons</strong> made for everyone. 
          Free forever. No signup needed. Start learning in 30 seconds.
        </p>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
            ...
            <h3 className="text-xl font-semibold mb-2">Easy Timeline</h3>
            <p className="text-gray-600">See all events in order. From birth to death. Simple and clear.</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
            ...
            <h3 className="text-xl font-semibold mb-2">True Stories</h3>
            <p className="text-gray-600">Real stories from his life. All from trusted books. No made-up tales.</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
            ...
            <p className="text-gray-600">Learn how to be kind, brave, and good. Just like Prophet Muhammad ﷺ.</p>
          </div>
        </div>
      </div>
    </section>
